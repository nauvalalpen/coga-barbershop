...
<head>
    ...
    <title>Register - COGA Barbershop</title>
    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 768px) {
            ...
            /* Hide brand section on mobile for more form space */
            .auth-form-section {
                padding: 40px 30px;
            }
...
<body>
    <div class="auth-container">
        ...
        <div class="auth-brand">
            ...
            <p class="brand-subtitle">Join The Club</p>
        </div>
            ...
            <form action="/register" method="post" id="registerForm">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="email" class="form-control" name="email" id="email" value="<?= old('email') ?>" placeholder="your@email.com" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <i class="input-icon fas fa-lock"></i>
                        <input type="password" class="form-control" name="pass_confirm" id="pass_confirm" placeholder="Re-enter your password" required>
