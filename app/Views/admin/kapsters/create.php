...
<form action="/admin/kapsters/create" method="post" enctype="multipart/form-data" id="createForm">
    <div class="modal-body" style="padding: 2rem;">
        ...
        <div class="row">
            <div class="col-md-6 mb-4">
                ...
                <div class="form-helper">
                    ...
                    <span>Enter the barber's full name</span>
                </div>
            </div>
            ...
            <div class="col-md-6 mb-4">
                ...
                <div class="form-helper">
                    <i class="fas fa-info-circle"></i>
                    <span>Used for login access</span>
                </div>
            </div>
        </div>
        ...
        <div class="mb-4">
            ...
            <div class="form-helper">
                <i class="fas fa-info-circle"></i>
                <span>Minimum 6 characters (barber can change later)</span>
            </div>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text"
                ...
                placeholder="e.g., Fade, Classic Cut, Beard Styling">
            <div class="form-helper">
                <i class="fas fa-info-circle"></i>
                <span>Enter barber's area of expertise (optional)</span>
            </div>
        </div>
